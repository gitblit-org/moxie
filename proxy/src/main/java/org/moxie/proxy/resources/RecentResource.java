...
public class RecentResource extends BaseResource {
	...
	public Representation toText() {
		...
		List<SearchResult> results = getApplication().getRecentArtifacts(repository, page, count);
