...
public class Boot {
    ...
    public final static String P_SHOW_ARGS = PROPERTY_PREFIX + "show.args";
    ...
    public final static String[] HELP_PROPERTIES = {
        ...
        P_SHOW_ARGS, "true:  Shows the command-line launch arguments passed to OneJar.",
    };
    ...
    /**
     * Java agent memory instrumentation
     */
    private static Instrumentation instrumentation;

    public static void premain(String options, Instrumentation inst) {
        Boot.instrumentation = inst;
    }
